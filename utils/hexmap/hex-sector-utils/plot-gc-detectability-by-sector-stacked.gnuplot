...
plot 'ausdata-minus-orchids-gc-detectability-by-hex-sector.csv' using 4 t "Detectable", '' using 5:xtic(nth(2,3,10)) t "Undetectable"

set output "detectability-gcTH-0p15.png"
set title "Green Contrast threshold 0.15"
plot 'ausdata-minus-orchids-gc-detectability-by-hex-sector.csv' using 8 t "Detectable", '' using 9:xtic(nth(2,3,10)) t "Undetectable"

set output "detectability-gcTH-0p20.png"
set title "Green Contrast threshold 0.20"
plot 'ausdata-minus-orchids-gc-detectability-by-hex-sector.csv' using 12 t "Detectable", '' using 13:xtic(nth(2,3,10)) t "Undetectable"

set output "detectability-gcTH-0p25.png"
set title "Green Contrast threshold 0.25"
plot 'ausdata-minus-orchids-gc-detectability-by-hex-sector.csv' using 16 t "Detectable", '' using 17:xtic(nth(2,3,10)) t "Undetectable"
