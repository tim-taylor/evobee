...
|learning-strategy|strLearningStrategy|std::string|Defines how the pollinator learns from experience (NB for this parameter to have effect, Allowed values: stay, fickle-circumspect, deliberative-decisive|
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjIwMDUyNyw2MjczNDY4NTYsLTE5NT
