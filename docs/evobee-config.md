...
|constancy-type|strConstancyType|std::string|Defines the pollinator's constancy behaviour while foraging (NB 'simple'=. 'visual'=utilise the pollinator's full visual system). Allowed values: none, simple, visual|
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTU3NjY5MjMsNjcxMDA2NDUxLDYyNz
