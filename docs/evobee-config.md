...
|innate-preference-type|strInnatePrefType|std::string|Specifies the pollinators' innate preferences. This parameter is used when colour-system = "arbitrary-dominant-wavelengths" and learning-strategy = "stay-innate". Allowed values: **giurfa** (default), **hoverfly**, **flat**, **preset**. With "flat", all wavelengths are given the same relative preference. With "preset"|
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTE4Njk3NDYsNjE4MzA2ODE4LDE2Mz
c1OTg2ODgsMTg0ODgyMDAzMSwtMjAxMTE2MDc4NiwtNTY4OTIx
MjMyLDY2MDQ4MTE0NywxOTkyMjk2MjU0LDEyMzg3MzI0NiwxOD
U2NjQ5NTgzLC04NDk4MDY1NDcsLTcyODg5MzM0NCwxNzAyOTgx
NDUsLTExNTY2Nzc5NjQsNTA4NTg1MDAyLDc0NDE2ODY2OCwtMT
I5ODY3NzUwOCwtMTMzNDUwMDYyNiwxOTg3NDgzNzg5LDE4MTY0
MzE3NDVdfQ==
-->